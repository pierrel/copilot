...
* Installation
For development tasks, this project now uses Eldev. Common commands:
- =eldev deps=: install dev/test dependencies
- =eldev test=: run ERT tests
- =eldev lint=: run checkers
